...
Das Ziel der Arbeit ist die Herausarbeitung von potentiellen Möglichkeiten, die der Einsatz von Edge Computing im Vergleich zu Cloud Computing bei autonomen Fahrzeugen ermöglicht. Aktuelle Problematiken, welche den flächendeckenden Einsatz von autonomen Fahrzeugen behindern, werden beleuchtet. Und wie potentiellen Schwachstellen durch die Verwendung von Edge Computing ausgeräumt werden können.
